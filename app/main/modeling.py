...
# Цена
# Размеры завода Plant_size (Решение игрока)
# Затраты на продвижение Promotion (решение игрока)
# Себестоимость PrimeCost  (Расчетный параметр)
# Качество ?????? (Уточнить)
# Спрос Demand (Расчетный по итогам всех команд)
# Объем продаж Sales_M (Расчетный по итогам всех команд)
# Общий объем продаж Sales (Расчетный по итогам всех команд)
# Прибиль в периоде Profit (Расчетный по итогам всех команд)
# Общий объем прибыли Acc_Profit (Расчетный по итогам всех команд)
